...
Most skills travel as opaque bundles or as prose you skim once. open-skills takes the opposite stance: every skill is plain text you can read before you trust it, and 40 of 70 add a declarative protocol you can inspect and validate with a public tool. Inspection is the defense. This document explains what that defends against, and — just as important — what it does not.
...
- **30 of 70 skills are Markdown-only.** They carry no `protocol.yon`, so their behavior is described only in prose. The 40 dual-document skills add a checkable declaration, not a runtime-obedience guarantee. Read both forms as instructions granted your agent's permissions.
